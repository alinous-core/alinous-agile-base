...
public class CsvCloseOutputFile extends AbstractSystemFunction
{
	public static final String QUALIFIED_NAME = "CSV.CLOSEOUTPUTFILE";
	
	public static final String FILE_PATH = "filePath";
	
	public CsvCloseOutputFile()
	{
			...
			throws ExecutionException, RedirectRequestException
	{
		...
		fileManager.closeWriteFile(filePath);
	...
	public String codeAssistString() {
		return "Csv.closeOutputFile($filePath)";
	}

	@Override
	public String descriptionString() {
		return "Close opened csv file to write data, and flush buffered output data.";
	}
