...
public class CsvOpenReadFile extends AbstractSystemFunction
{
	public static final String QUALIFIED_NAME = "CSV.OPENREADFILE";
	
	public static final String FILE_PATH = "filePath";
	public static final String ENCODING = "encoding";
	
	public CsvOpenReadFile()
	{
			...
			throws ExecutionException, RedirectRequestException
	{
		...
		try {
			fileManager.openCsvReader(filePath, encode);
	...
	public String codeAssistString() {
		return "Csv.openReadFile($filePath, $encoding)";
	}


	@Override
	public String descriptionString() {
		return "Open csv file to read records.";
	}
