...
public class CsvCloseReadFile extends AbstractSystemFunction
{
	public static final String QUALIFIED_NAME = "CSV.CLOSEREADFILE";
	
	public static final String FILE_PATH = "filePath";

	public CsvCloseReadFile()
	{
			...
			throws ExecutionException, RedirectRequestException
	{
		...
		fileManager.closeCsvReader(filePath);
	...
	public String codeAssistString() {
		return "Csv.closeReadFile($filePath)";
	}

	@Override
	public String descriptionString() {
		return "Close opened csv file to to read.";
	}
