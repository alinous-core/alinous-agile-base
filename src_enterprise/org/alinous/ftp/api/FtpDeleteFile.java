...
public class FtpDeleteFile extends AbstractSystemFunction
{
	public static final String QUALIFIED_NAME = "FTP.DELETEFILE";
	...
	public IScriptVariable executeFunction(PostContext context, VariableRepository valRepo) throws ExecutionException, RedirectRequestException
	{
		...
		try {
			mgr.deleteFile(sessionId, remote);
	...
	public String codeAssistString() {
		return "Ftp.deleteFile($sessionString, $remote)";
	}

	@Override
	public String descriptionString() {
		return "Delet remote file $remote.";
	}
}
