...
public class FtpUploadFile extends AbstractSystemFunction
{
	public static final String QUALIFIED_NAME = "FTP.UPLOADFILE";
	...
	public IScriptVariable executeFunction(PostContext context, VariableRepository valRepo) throws ExecutionException, RedirectRequestException
	{
		...
		try {
			mgr.uploadFile(sessionId, path, remote);
	...
	public String codeAssistString() {
		return "Ftp.uploadFile($sessionString, $path, $remote)";
	}

	@Override
	public String descriptionString() {
		return "Upload a local file to the remote as $remote.";
	}
}
