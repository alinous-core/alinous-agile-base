...
public class FtpLogin extends AbstractSystemFunction
{
	public static final String QUALIFIED_NAME = "FTP.LOGIN";
	...
	public IScriptVariable executeFunction(PostContext context, VariableRepository valRepo) throws ExecutionException, RedirectRequestException
	{
		...
		try {
			mgr.login(sessionId, username, password);
	...
	public String codeAssistString() {
		return "Ftp.login($sessionString, $username, $password)";
	}

	@Override
	public String descriptionString() {
		return "Login into the Ftp server. Call this function after Ftp.Connect().";
	}
}
