...
public class TreeNodeClearCurrent extends AbstractSystemFunction
{
	public static String QUALIFIED_NAME = "NODETREE.CLEARCURRENT";
	public static String TREE_NAME = "treeName";
	
	public TreeNodeClearCurrent()
	{
	...
	public IScriptVariable executeFunction(PostContext context, VariableRepository valRepo) throws ExecutionException, RedirectRequestException
	{
		...
		sessionManager.clearCurrent(config);
