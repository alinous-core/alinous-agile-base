...
public class NodeTreeGetCategory extends AbstractSystemFunction
{
	public static final String QUALIFIED_NAME = "NODETREE.GETCATEGORY";
	
	public static final String TREE_NAME = "treeName";
	public static final String NODE_ID = "nodeId";
	
	
	public NodeTreeGetCategory()
	{
	...
	public IScriptVariable executeFunction(PostContext context, VariableRepository valRepo) throws ExecutionException, RedirectRequestException
	{
		...
		try {
			...
			ScriptDomVariable domVal = new ScriptDomVariable("result");
			domVal.setValue(nodeModel.getCategory());
