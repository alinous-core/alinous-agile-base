...
public class NodeTreeGetNextNode extends AbstractSystemFunction
{
	public static String QUALIFIED_NAME = "NODETREE.GETNEXTNODE";
	public static String TREE_NAME = "treeName";
	public static String NODE_ID = "nodeId";
	
	public NodeTreeGetNextNode()
	{
			...
			throws ExecutionException, RedirectRequestException
	{
		...
		try {
			...
			NodeModel node = NodeModelUtils.getNextNode(con, config, nodeId);
