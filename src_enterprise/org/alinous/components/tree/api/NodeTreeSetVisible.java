...
public class NodeTreeSetVisible extends AbstractSystemFunction
{
	public static String QUALIFIED_NAME = "NODETREE.SETVISIBLE";
	
	public static String TREE_NAME = "treeName";
	public static String NODE_ID = "nodeId";
	public static String VISIBLE = "visible";
	
	public NodeTreeSetVisible()
	{
		...
		arg = new ArgumentDeclare("$", VISIBLE);
		this.argmentsDeclare.addArgument(arg);
	}
	...
	public IScriptVariable executeFunction(PostContext context, VariableRepository valRepo) throws ExecutionException, RedirectRequestException
	{
		...
		ipath = PathElementFactory.buildPathElement(VISIBLE);
		IScriptVariable visibleVariable = newValRepo.getVariable(ipath, context);
		
		if(!(treeNameVariable instanceof ScriptDomVariable) ||
				!(nodeIdVariable instanceof ScriptDomVariable) || !(visibleVariable instanceof ScriptDomVariable)){
		...
		String visible = ((ScriptDomVariable)visibleVariable).getValue();
