...
public class NodeTreeSetTitle extends AbstractSystemFunction
{
	public static String QUALIFIED_NAME = "NODETREE.SETTITLE";
	public static String TREE_NAME = "treeName";
	public static String NODE_ID = "nodeId";
	public static String TITLE = "title";
	
	public NodeTreeSetTitle()
	{
	...
	public IScriptVariable executeFunction(PostContext context, VariableRepository valRepo) throws ExecutionException, RedirectRequestException
	{
		...
		if(!(treeNameVariable instanceof ScriptDomVariable) ||
				!(nodeIdVariable instanceof ScriptDomVariable) || !(titleVariable instanceof ScriptDomVariable)){
