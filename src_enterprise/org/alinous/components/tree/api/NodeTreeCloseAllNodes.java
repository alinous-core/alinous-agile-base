...
public class NodeTreeCloseAllNodes extends AbstractSystemFunction
{
	public static final String QUALIFIED_NAME = "NODETREE.CLOSEALLNODES";
	public static final String TREE_NAME = "treeName";
	
	public NodeTreeCloseAllNodes()
	{
	...
	public IScriptVariable executeFunction(PostContext context, VariableRepository valRepo) throws ExecutionException, RedirectRequestException
	{
		...
		sessionManager.closeAll(config);
