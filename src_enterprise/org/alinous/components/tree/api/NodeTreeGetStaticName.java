...
public class NodeTreeGetStaticName extends AbstractSystemFunction
{
	public static final String QUALIFIED_NAME = "NODETREE.GETSTATICNAME";
	public static final String TREE_NAME = "treeName";
	public static final String NODE_ID = "nodeId";
	public static final String OUT_PATH = "outPath";
	
	public NodeTreeGetStaticName()
	{
	...
	public ScriptDomVariable executeFunction(PostContext context, VariableRepository valRepo) throws ExecutionException, RedirectRequestException
	{
		...
		try {
			...
			result = new ScriptDomVariable("result");
			
			result.setValue(path);
			result.setValueType(IScriptVariable.TYPE_STRING);
		} catch (DataSourceException e) {
			throw new ExecutionException(e, "Failed in connection db. at " + QUALIFIED_NAME); // i18n
		}finally{
			con.close();
		}
