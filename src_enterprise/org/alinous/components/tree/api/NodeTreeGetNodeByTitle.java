...
public class NodeTreeGetNodeByTitle extends AbstractSystemFunction
{
	public static String QUALIFIED_NAME = "NODETREE.GETNODEBYTITLE";
	public static String TREE_NAME = "treeName";
	public static String TITLE = "title";

	
	public NodeTreeGetNodeByTitle()
	{
	...
	private ScriptDomVariable list2Dom(List<NodeModel> list)
	{
		if(list.isEmpty()){
			ScriptDomVariable valDom = new ScriptDomVariable("null");
			valDom.setValueType(IScriptVariable.TYPE_NULL);
			return valDom;
		}
		
		NodeModel model = list.get(0);
