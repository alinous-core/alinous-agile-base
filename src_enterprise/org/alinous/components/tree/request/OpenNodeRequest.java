...
public class OpenNodeRequest implements IRequest
{
	private NodeTreeRenderModel renderer;
	
	public OpenNodeRequest(NodeTreeRenderModel renderer)
	{
	...
	public void processRequest() throws AlinousException
	{
		...
		sessionMgr.open(this.renderer.getConfig(), this.renderer.getNodeId());
