...
public class CmdPosUp implements INodeTreeCommand
{
	private NodeTreeRenderModel renderer;
	private PostContext context;
	
	public CmdPosUp(NodeTreeRenderModel renderer, PostContext context)
	{
	...
	private void doPosUp(DataSrcConnection con, NodeModel model) throws ExecutionException, DataSourceException
	{
		NodeModel bros = getElderBrother(con, model);
	...
	private NodeModel getElderBrother(DataSrcConnection con, NodeModel model) throws ExecutionException, DataSourceException
	{
