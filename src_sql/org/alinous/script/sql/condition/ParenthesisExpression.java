...
public class ParenthesisExpression implements ISQLContainerExpression
{
	...
	{
		return "(" + this.expressions.get(0).extract(context, providor, adjustWhere, adjustSet, helper) + ")";
	}
