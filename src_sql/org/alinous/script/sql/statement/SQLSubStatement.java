...
public class SQLSubStatement implements ISQLStatement
{
	private String ope;
	...
	{
		return this.ope + " " + this.statement.extract(context, providor, adjustWhere, adjustSet, helper);
	}

	public boolean isReady(PostContext context, VariableRepository providor, AdjustWhere adjustWhere) throws ExecutionException
	{
		return statement.isReady(context, providor, adjustWhere);
	}
	...
	public String extractPrecompile(PostContext context,
			...
			AdjustSet adjustSet, TypeHelper helper) throws ExecutionException
	{
		return this.ope + " " + this.statement.extractPrecompile(context, providor, adjustWhere, adjustSet, helper);
	}
}
