...
public class HeadTagObject extends XMLTagBase implements IHtmlObject
{
	public IAlinousObject fork() throws AlinousException
	{
		HeadTagObject newObj = new HeadTagObject();
	...
	public void renderContents(PostContext context, VariableRepository valRepo, Writer wr, int n) throws IOException, AlinousException
	{
		...
		// Add copyright
		//wr.append("<meta name=\"generator\" content=\"Alinous-Core Professional Edition\" >\n");
