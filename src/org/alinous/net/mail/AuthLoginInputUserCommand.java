...
public class AuthLoginInputUserCommand extends AbstractSmptCommand
{

	public AuthLoginInputUserCommand(SmtpProtocol proto)
	{
		super(proto);
	}
	...
	{
		String encodedUser = base64Encode(this.proto.getUserName());
		
		sendCommand(encodedUser, con);
	}
