...
public class NotifyStepInFinishedCommand extends AbstractAlinousServerCommand {
	public static final String CMD_STRING = "STEPIN_FINISHED";
	...
	public NotifyStepInFinishedCommand(Thread thread) {
		super(thread);
	}
