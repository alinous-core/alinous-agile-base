...
public class NotifyHitBreakpoint extends AbstractAlinousServerCommand {
	public static final String CMD_STRING = "HIT_BREAK_POINT";
	
	public NotifyHitBreakpoint(Thread thread) {
		super(thread);
	}
	
	@Override
	public void sendCommand(List<IServerCommand> liservedqueue, List<IServerCommand> needfinish,
			ICommandSender notifier, PostContext contxt) throws IOException 
	{
		super.sendCommand(liservedqueue, needfinish, notifier, contxt);

		//notifier.debugOut("# Server Command : " + this);
		//notifier.sendCommand(this);
