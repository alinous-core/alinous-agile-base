...
public class NotifyThreadStartCommand extends AbstractAlinousServerCommand {
	public static final String CMD_STRING = "THREAD_START";

	public NotifyThreadStartCommand(Thread thread) {
		super(thread);
	}
			...
			ICommandSender notifier, PostContext context) throws IOException
	{
		synchronized (liservedqueue) {
			liservedqueue.add(this);
		}
		
		notifier.debugOut("# store comand " + this);
	}
