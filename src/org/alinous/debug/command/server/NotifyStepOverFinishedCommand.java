...
public class NotifyStepOverFinishedCommand extends AbstractAlinousServerCommand {
	public static final String CMD_STRING = "STEPOVER_FINISHED";
	...
	public NotifyStepOverFinishedCommand(Thread thread) {
		super(thread);
	}
