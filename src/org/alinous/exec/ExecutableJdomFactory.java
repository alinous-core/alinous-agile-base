...
public class ExecutableJdomFactory
{
	public static IExecutable createFirstExecutable(Element element) throws AlinousException
	{
		String className = element.getAttributeValue(IExecutable.ATTR_CLASS);
		...
		try {
			exec = (IExecutable)Class.forName(className).newInstance();
