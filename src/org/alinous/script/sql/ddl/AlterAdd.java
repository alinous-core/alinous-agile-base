...
public class AlterAdd implements IAlterAction
{
	private DdlColumnDescriptor columnDesc;
			...
			AdjustSet adjustSet, TypeHelper helper) throws ExecutionException
	{
		...
		buffer.append("ADD ");
		buffer.append(this.columnDesc.extract(context, valRepo, adjustWhere, adjustSet, helper));
	...
	public DdlColumnDescriptor getColumnDesc()
	{
		return columnDesc;
	}

	public void setColumnDesc(DdlColumnDescriptor columnDesc)
	{
