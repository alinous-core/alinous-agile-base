...
public class CreateFunctionSentence extends FunctionBase
{
			...
			throws ExecutionException
	{
		...
		try {
			con.createFunction(this.func);
		} catch (DataSourceException e) {
			con.close();
			throw new ExecutionException(e, "Failed in creating finction at line " + this.getLine());
		}
	...
	{
		this.func.setSetof(setof);
	}
	public void setRetType(ColumnTypeDescriptor retType)
	{
		this.func.setRetType(retType);
	}
	public void setProgram(String program)
	{
		this.func.setProgram(program);
	}
	public void setLanguage(String language)
	{
		this.func.setLanguage(language);
	}
	public void setRelpace(boolean relpace)
	{
		this.func.setRelpace(relpace);
	}
