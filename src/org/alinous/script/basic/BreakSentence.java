...
public class BreakSentence implements IScriptSentence
{
	private int line;
	...
	{
		Element breakElement = new Element(IExecutable.TAG_EXECUTABLE);
		breakElement.setAttribute(IExecutable.ATTR_CLASS, this.getClass().getName());
		
		parent.addContent(breakElement);
	}
