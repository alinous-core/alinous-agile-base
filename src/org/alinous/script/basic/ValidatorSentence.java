...
public class ValidatorSentence implements IScriptSentence
{
	private int line;
	...
	{
		Element validatorElement = new Element(IExecutable.TAG_EXECUTABLE);
		validatorElement.setAttribute(IExecutable.ATTR_CLASS, this.getClass().getName());
		
		parent.addContent(validatorElement);
		
		// statement
		this.args.exportIntoJDomElement(validatorElement);
	}
