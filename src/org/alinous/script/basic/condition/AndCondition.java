...
public class AndCondition implements IScriptCondition
{
	...
	public List<IScriptCondition> getConditions()
	{
		return conditions;
	}

	public void setConditions(List<IScriptCondition> conditions)
	{
	...
	public void getFunctionCall(ScriptCheckContext scContext, List<FunctionCall> call, AlinousScript script)
	{
		...
		while(it.hasNext()){
			...
			cond.getFunctionCall(scContext, call, script);
